  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-10 min-h-screen">
      ...
      <div className="text-center mb-10">
        <span className="bg-bgAccent text-primary px-4 py-1.5 rounded-full text-sm font-semibold font-prompt inline-block mb-3">
      ...
      {!checkingAuth && !currentUser && (
        <div className="bg-amber-50 border border-amber-200 text-amber-800 rounded-2xl p-4 mb-8 flex items-center justify-between gap-4 font-prompt text-sm">
          <div className="flex items-center gap-3">
            <i className="fa-solid fa-triangle-exclamation text-amber-500 text-lg"></i>
            <span>
              คุณยังไม่ได้เข้าสู่ระบบ ระบบจะบันทึกรายงานในฐานะ <strong>ผู้แจ้งทั่วไป</strong>
            </span>
          </div>
          <Link
            href="/login"
